  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url() ?>">
        ...
        <div class="sidebar-brand-text mx-3">AKORNAS</div>
      </a>
      ...
      <?php if($id == 1): ?>
      <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#pegawai" aria-expanded="true" aria-controls="collapseTwo">
          <i class="fas fa-fw fa-user"></i>
        ...
        <div id="pegawai" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item <?= isset($dosen) == 'dosen' ? 'active' : null ?>" href="<?= base_url('dosen') ?>">Dosen</a>
            <a class="collapse-item <?= isset($pegawai) == 'pegawai' ? 'active' : null ?>" href="<?= base_url('pegawai') ?>">Tenaga Pendidikan</a>
          </div>
        </div>
      </li>
      <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#kinerja" aria-expanded="true" aria-controls="collapseTwo">
          <i class="fas fa-fw fa-list-ol"></i>
          <span>Penilaian Kinerja</span>
        </a>
        <div id="kinerja" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Kinerja:</h6>
            <a class="collapse-item <?= isset($k_dosen) == 'k_dosen' ? 'active' : null ?>" href="<?= base_url('kinerja/k_dosen') ?>">Dosen</a>
            <a class="collapse-item <?= isset($k_pegawai) == 'k_pegawai' ? 'active' : null ?>" href="<?= base_url('kinerja/k_pegawai') ?>">Tenaga Pendidikan</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="absensi" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item <?= isset($a_dosen) == 'a_dosen' ? 'active' : null ?>" href="<?= base_url('absensi/a_dosen') ?>">Dosen</a>
            <a class="collapse-item <?= isset($a_pegawai) == 'a_pegawai' ? 'active' : null ?>" href="<?= base_url('absensi/a_pegawai') ?>">Tenaga Pendidikan</a>
          </div>
        </div>
      </li>
      <?php endif; ?>     
