<?php
    ...
    // menghubungkan file header dengan file detail dosen
    require_once "_template/_header.php";

    //simpan data id(nip) yang dikirim dari halaman dosen ke dalam variabel nip
    $nip = $_GET['id'];
    ...
    // cek data function yang dikirim dari halaman sebelumnya untuk menampilkan detail data dosen yang diinginkan
    ...
    $data_detail = query("SELECT * FROM dosen WHERE nip='$nip'");
        ...
        <div class="card shadow mb-4 border-left-primary">
            <div class="card-body">
                <div class="text-center">
                    <img src="<?= asset('_assets/img/').$data_detail[0]['foto_dosen']; ?>" class="img-fluid shadow" alt="Foto Dosen">
                    <h2 class="mt-3"><?= ucwords($data_detail[0]['nama_dosen']) ?></h2>
...
<?php
    ...
    // menghubungkan file footer dengan file detail dosen
