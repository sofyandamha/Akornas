...
<div class="card mb-4">
    <div class="card-body">
        <form method="POST" action="<?= base_url('_config/proses_pegawai') ?>?add" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                <label for="nama_pegawai" class="col-sm-3 col-form-label">Nama Tenaga Pendidikan</label>
                <div class="col-sm-9">
                    <input type="text" class="form-control" name="nama_pegawai" id="nama_pegawai" placeholder="Nama Tenaga Pendidikan" required autocomplete="off">
                </div>
            </div>
            <div class="form-group row">
