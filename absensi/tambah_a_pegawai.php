...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    <li class="breadcrumb-item"><a href="<?= base_url('absensi/a_pegawai') ?>">Data Absensi T. Pendidikan</a></li>
...
<div class="card mb-4">
    <div class="card-body">
        <form method="POST" action="<?= base_url('_config/proses_a_pegawai') ?>?add" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="time" class="form-control" name="jam_masuk" id="jam_masuk" required autocomplete="off" autofocus>
                </div>
            </div>
            <div class="form-group row">
                <label for="jam_keluar" class="col-sm-3 col-form-label">Jam Keluar</label>
                <div class="col-sm-9">
                    <input type="time" class="form-control" name="jam_keluar" id="jam_keluar"  required autocomplete="off">
                </div>
            </div>
    ...
    <div class="card-footer">
        ...
        <a href="<?= base_url('kinerja/a_pegawai') ?>" class="btn btn-warning"><i class="fas fa-fw fa-chevron-left"></i> Kembali</a>
    </div>
    </form>
</div>
