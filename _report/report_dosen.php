<?php
    ...
    $dompdf = new Dompdf();
    $nip = $_GET['id'];
    $pegawai = query("SELECT * FROM dosen WHERE nip='$nip'");

    $content = '<center><h3>Data Tenaga Pendidikan</h3></center><hr/><br/>';
    $content .= '<table width="100%">
    <tr>
        <td align="center">
            <img src="../_assets/img/'.$pegawai[0]['foto_dosen'].'" width="75px" height="113px" alt="profil">
        </td>
        <td>
            <table width="100%" cellspacing="0" cellpadding="3" border="0">
                ...
                <tr>
                    ...
                    <th> : </th>
                    <td> '.ucwords($pegawai[0]['nama_dosen']).' </td>
                </tr>
                <tr>
                ...
                <tr>
                    <th align="left">Struktural</th>
                    <th> : </th>
                    <td> '.ucwords($pegawai[0]['struktural']).' </td>
                </tr>
                <tr>
                    <th align="left">Tahun Pensiun</th>
                    <th> : </th>
                    <td> '.ucwords($pegawai[0]['tahun_pensiun']).' </td>
                </tr>
            </table>
        </td>
    </tr>
    ...
    $dompdf->stream("Data Dosen.pdf",["Attachment" => false]);