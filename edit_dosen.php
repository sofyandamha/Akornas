...
<div class="card mb-4">
    <div class="card-body">
        <form method="POST" action="<?= base_url('_config/proses_dosen') ?>?edit" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" name="nik" id="nik" placeholder="NIK" value="<?= $data['nik'] ?>" required autocomplete="off">
                </div>
            </div>
            <div class="form-group row">
                <label for="nama_dosen" class="col-sm-3 col-form-label">Nama Dosen</label>
                <div class="col-sm-9">
                    <input type="text" class="form-control" name="nama_dosen" id="nama_dosen" value="<?= $data['nama_dosen'] ?>" placeholder="Nama Dosen" required autocomplete="off">
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                <label for="stat_dosen" class="col-sm-3 col-form-label">Status Kepegawaian</label>
                <div class="col-sm-9">
                    <select class="form-control" name="stat_dosen" id="stat_dosen" required autocomplete="off">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                <input type="text" class="form-control" id="jabatan" name="jabatan" placeholder="Jabatan" value="<?= $data['jabatan'] ?>" required autocomplete="off">
                </div>
            </div>
            <div class="form-group row">
                <label for="struktural" class="col-sm-3 col-form-label">Struktural</label>
                <div class="col-sm-9">
                <input type="text" class="form-control" id="struktural" name="struktural" placeholder="Struktural" value="<?= $data['struktural'] ?>" required autocomplete="off">
                </div>
            </div>
            <div class="form-group row">
                <label for="tahun_pensiun" class="col-sm-3 col-form-label">Tahun Pensiun</label>
                <div class="col-sm-9">
                <input type="number" class="form-control" id="tahun_pensiun" name="tahun_pensiun" placeholder="Tahun Pensiun" value="<?= $data['tahun_pensiun'] ?>" required autocomplete="off">
                </div>
            </div>
            <div class="form-group row">
                <label for="nip" class="col-sm-3 col-form-label">Pas Photo</label>
                <div class="col-sm-9">
                    <a href="<?= asset('_assets/img/').$data['foto_dosen'] ?>" target="_blank" class="text-decoration-none">
                        <img src="<?= asset('_assets/img/').$data['foto_dosen'] ?>" alt="Foto Dosen" class="img-fluid mb-3" width="60px" height="70px">
                    </a>
                    <input type="hidden" name="foto_lama" value="<?= $data['foto_dosen'] ?>">
    ...
    <div class="card-footer">
        ...
        <a href="<?= base_url('dosen') ?>" class="btn btn-warning"><i class="fas fa-fw fa-chevron-left"></i> Kembali</a>
    </div>
    </form>
</div>
