...
<div class="card mb-4">
    <div class="card-body">
        <form method="POST" action="<?= base_url('_config/proses_dosen') ?>?add" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" name="nik" id="nik" placeholder="NIK" required autocomplete="off" autofocus>
                </div>
            </div>
            <div class="form-group row">
                <label for="nama_dosen" class="col-sm-3 col-form-label">Nama Dosen</label>
                <div class="col-sm-9">
                    <input type="text" class="form-control" name="nama_dosen" id="nama_dosen" placeholder="Nama Dosen" required autocomplete="off">
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                <label for="stat_dosen" class="col-sm-3 col-form-label">Status Dosen</label>
                <div class="col-sm-9">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" name="struktural" id="struktural" placeholder="Struktural" required autocomplete="off">
                </div>
            </div>
            <div class="form-group row">
                <label for="tahun_pensiun" class="col-sm-3 col-form-label">Tahun Pensiun</label>
                <div class="col-sm-9">
                    <input type="number" class="form-control" name="tahun_pensiun" id="tahun_pensiun" placeholder="Tahun Pensiun" required autocomplete="off">
                </div>
            </div>
            <div class="form-group row">
